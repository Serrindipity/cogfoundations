...
```{r fig2.0, echo = FALSE, out.width='100%', fig.align = 'center'}
knitr::include_graphics("images/ch2/intro.jpeg")
```
...
```{r monalisa, echo = FALSE, out.width='30%', fig.align = 'center', fig.cap = "Mona Lisa's smile."}
...
```{r mcgurk, echo = FALSE, out.width='35%', fig.align = 'center', fig.cap = 'Watch [The McGurk Effect on YouTube](http://www.youtube.com/watch?v=jtsfidRq2tw)'}
knitr::include_graphics("images/ch2/mcgurk.png")
```
...
```{r ponzoillusion, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'The Ponzo Illusion. The Ponzo illusion is caused by a failure of the monocular depth cue of linear perspective. Both bars are the same size, even though the top one looks larger.'}
...
```{r humanfactors, echo = FALSE, out.width='80%', fig.align = 'center', fig.cap = 'Airplane instrument panel before (left) and after (right) it was redesigned by human factors psychologists.'}
knitr::include_graphics("images/ch2/fig8.png")
```
:::
