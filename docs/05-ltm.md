...
This simple example reveals the remarkable complexity of long-term memory: your bicycle knowledge isn't stored as a single memory but as multiple, interconnected memory systems. Some memories guide your actions (riding skills), others preserve your personal experiences (first bicycle ride), and still others store facts and concepts (what bicycles are). Of course, we remember far more than bicycles. Our long-term memory systems allow us to do everything from recalling a WiFi password to writing computer programs, from recognizing faces to playing musical instruments. Moreover, our memories define us as individuals: they are our experiences, our relationships, our successes, and our failures. Without your memories, would you still be you?
...
Primacy and recency effects can be explanied in terms of how rehearsal affects short-term and long-term memory [@Baddeley1990]. The primacy effect happens because early words get more rehearsal time. When you hear the first word in a list, you immediately start rehearsing it. This extra rehearsal helps transfer the word from short-term to long-term memory. The same advantage applies to the other early words in the list: they get more rehearsal because you encounter them when your working memory isn't yet overloaded. The recency occurs for a different reason. The last few words in a list (i.e., the most recent words you heard, hence "recency") are still available in short-term memory when you try to recall them. You can easily retrieve them through maintenance rehearsal by simply repeating them to yourself. Words in the middle of the list don't get either of these advantages. Unlike the first words, they receive less rehearsal because your working memory was already busy juggling multiple items when you encountered them. Unlike the last words, they're no longer available in short-term memory by the time you recall the list. This double disadvantage makes the middle words less likely to be remembered.
