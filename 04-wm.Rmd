...
```{r fig4.0, echo = FALSE, out.width='100%', fig.align = 'center'}
knitr::include_graphics("images/ch4/fig0.png")
```
...
```{r modalmodel, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'The simplest version of Atkinson and Shiffrin’s Modal Model of Memory.'}
knitr::include_graphics("images/ch4/fig1.png")
```
...
```{r chess, echo = FALSE, out.width='80%', fig.align = 'center', fig.cap = 'Left: A chessboard in the middle of a real game. Right: A random arrangement of chess pieces. Chess experts have significantly better memory for real boards, but perform more like novices for random board configurations.'}
knitr::include_graphics("images/ch4/chess.png")
```
...
```{r baddeley, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'The original multicomponent working memory model from @BADDELEY197447.'}
knitr::include_graphics("images/ch4/fig2.png")
```
...
```{r blockf, echo = FALSE, out.width='10%', fig.align = 'center', fig.cap = 'The block letter F task.'}
knitr::include_graphics("images/ch4/fig3.png")
```
...
### The episodic buffer {-}
Science is an ongoing process, and so despite the usefulness of Baddeley and Hitch’s working memory model, it was updated in 2000 to add another component: the episodic buffer [@Baddeley2000]. The [episodic buffer] is a limited capacity, temporary storage system that is controlled by the central executive and integrates information from a variety of sources including long-term memory (Figure \@ref(fig:episodic)). 

```{r episodic, echo = FALSE, out.width='50%', fig.align = 'center', fig.cap = 'An updated version of the multicomponent working memory model [@Baddeley2000].'}
knitr::include_graphics("images/ch4/episodic.png")
```
