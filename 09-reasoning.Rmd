...
```{r cover, echo = FALSE, out.width='100%', fig.align = 'center'}
 knitr::include_graphics("images/ch9/aisle.jpg")
```
...
```{r euler, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Euler Circles'}
...
```{r wason1, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Original Wason Selection Task cards'}
knitr::include_graphics("images/ch9/fig2.png")
```

```{r wason2, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Drinking-age Wason Selection Task'}
...
```{r induct, echo = FALSE, out.width='50%', fig.align = 'center', fig.cap = 'An example of inductive reasoning would be generalizing from the subset of crows you have seen to all crows.'}
knitr::include_graphics("images/ch9/fig4.png")
```
...
```{r bank, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Feminist bank tellers.'}
...
```{r reasoning, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Deductive and inductive reasoning.'}
...
```{r prospect, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'a) value weighting function and b) probability weighting function, both from Prospect Theory. v(.) refers to subjective utility, and w(.) refers to subjective probability.'}
